...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="profile-container">
        ...
        <div class="profile-details">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" BackColor="White" BorderStyle="None" BorderWidth="1px" DataSourceID="SqlDataSource1" ForeColor="#6C584C" GridLines="Horizontal" PageSize="4" ShowHeader="False" Width="586px" DataKeyNames="Id" CellPadding="0" CssClass="gridview">
                <Columns>
